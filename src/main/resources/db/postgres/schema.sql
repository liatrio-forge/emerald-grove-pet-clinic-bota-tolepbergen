...
CREATE INDEX IF NOT EXISTS idx_appointment_vet_date ON appointments (vet_id, appointment_date, start_time, end_time);
CREATE INDEX IF NOT EXISTS idx_appointment_pet_date ON appointments (pet_id, appointment_date);
